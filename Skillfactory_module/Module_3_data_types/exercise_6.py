    ...
    if command == 1:
        ...
        for stud in students:
            ...
            for clas in classes:
                ...
                if marks_count == 0:
                    marks_count = 1
                print(f'{clas} - {round(marks_sum / marks_count)}')
            print()
    elif command == 3:
        ...
        name_stud = check_for_inclusion_in_list(students,'Выберите студента', 'учеников', 'Введите номер ученика: ')
        name_clas = check_for_inclusion_in_list(classes,'Выберите предмет', 'предметов', 'Введите номер предмета: ')
        if len(students_marks[name_stud][name_clas]) > 0:
            while True:
            ...
            print(f'У ученика: {name_stud} по предмету: {name_clas} отсутствуют оценки!')
    elif command == 11:
